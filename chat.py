...
if llm:
    input_text = st.text_input("Input your query")
    ...
    if input_text:
        ...
        formatted_prompt = f"You are a chatbot. Please reply to the input given by the user accordingly.Remember what you were asked previously for context on future prompts\n\n{conversation_history_str}"
